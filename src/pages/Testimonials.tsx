  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <section className="relative h-[55vh] flex items-end pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0" style={{ backgroundImage: `url(/images/floral_detail.webp)`, backgroundSize: "cover", backgroundPosition: "center" }} />
      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-12 py-16">
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-serif text-base mb-1 text-white">{t.client}</p>
        ...
        <div className="mt-24 py-20 text-center border-t border-gold/10">
          ...
          <h2 className="text-display text-4xl lg:text-5xl mb-6 text-white">Ready to become part of the Alankaran story?</h2>
