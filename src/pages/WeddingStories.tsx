    ...
    <div className="bg-background text-foreground">
      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-12">
          ...
          <article key={s.couple} className="py-24 border-b border-border/40">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-12">
              <div>
                ...
                <h2 className="text-display text-4xl lg:text-6xl mb-4 text-white">
                  <motion.span
        ...
        <section className="py-24 text-center">
          ...
          <h2 className="text-display text-4xl lg:text-5xl mb-6 text-white">Ready to write your chapter?</h2>
          <Link href="/contact">
            <motion.button
