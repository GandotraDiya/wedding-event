    ...
    <div className="bg-background text-foreground">
      ...
      <section className="relative h-[65vh] flex items-end pb-20 overflow-hidden">
        ...
        <div className="relative max-w-screen-xl mx-auto px-6 lg:px-12 z-20">
          <motion.p className="section-label mb-4 text-gold" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}>
            What We Offer
          </motion.p>
      ...
      <div className="max-w-screen-xl mx-auto px-6 lg:px-12">
          ...
          {services.map((s, i) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <h3 className="font-serif text-2xl mb-4 text-white">{s.name}</h3>
        ...
        <section className="py-24 text-center border-t border-gold/10 bg-black">
          ...
          <h2 className="text-display text-4xl lg:text-6xl mb-6 text-white">Ready to start planning?</h2>
