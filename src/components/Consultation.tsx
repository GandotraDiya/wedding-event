  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[700px]">
        ...
        <div
          className="relative hidden lg:block bg-luxury-gradient"
        >
          {/* Decorative elements */}
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="text-center px-12">
              <div
                className="font-serif text-7xl mb-6 leading-none text-gold"
              >
                ✦
              </div>
              <p
                className="font-serif text-3xl lg:text-4xl leading-tight mb-6 text-white"
              >
        ...
        {/* Right: form panel */}
        <div
          className="relative flex flex-col justify-center px-6 md:px-12 xl:px-16 py-20 bg-black"
        >
          {/* Heading */}
          <div className="mb-12">
            <motion.p
          ...
          {submitted ? (
            ...
            >
                ...
                <div className="grid grid-cols-2 gap-3">
                  {sources.map((src) => (
                    ...
                    >
                      ...
                      <span
                        className={`font-sans font-light text-sm transition-colors ${
                          form.sources.includes(src)
                            ? "text-white"
              ...
              <motion.button
                type="submit"
                className="w-full py-4 font-sans text-xs uppercase tracking-widest transition-all bg-gold text-background hover:bg-gold/90 hover:gold-glow"
